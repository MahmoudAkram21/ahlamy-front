...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log(`[API Auth Login] Backend returned ${setCookieHeaders.length} cookies`);
    ...
    if (token) {
      console.log("[API Auth Login] Setting auth_token cookie on client");
      ...
      console.warn("[API Auth Login] No auth_token found in backend response");
    }
